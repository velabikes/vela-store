  ...
  <div className="HomePage">
    <Head>
      ...
      <link
        rel="alternate"
        hrefLang="pt-br"
        href="https://velabikes.com.br/vela"
      />
      ...
      <div className="section">
        <div className="right">
          <div className="right-content">
            ...
            <h4>
              Sensores de pedal com alta percepção de movimento, para você
              pedalar com agilidade e confiança
            </h4>
            <p>
              Ao iniciar seu trajeto, com o assistente de partida da Vela 2, a
              resposta do motor é ainda mais rápida e intensa.
            </p>
          </div>
          <a href="/vela2">
            <img
              src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/a142d80a-87e5-47b5-90ce-c76978dbd3a0.jpg"
              alt="Sensor de pedal bike elétrica"
            />
          </a>
        </div>
        <div className="left">
          <a href="/vela2">
            <img
              src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/e2f0d9af-8587-429c-956c-1aa6c902b398.jpg"
              alt="Bateria impermeável bicicleta elétrica"
            />
          </a>
          <div className="left-content">
            <h2>Removível e impermeável</h2>
            <h4>
              Conecte o carregador diretamente na bike ou retire a bateria para
              carregar onde e quando precisar
            </h4>
            <p>
              A bateria possui formato cilíndrico, feita com células de lítio e
              acabamento impermeabilizado. É projetada para encaixar no tubo do
              selim e ficar protegida no quadro.
            </p>
          </div>
        </div>
        <div className="right">
          <div className="right-content">
            ...
            <p>
              ...
              esforço, mesmo nas maiores inclinações.
            </p>
            <div className="actions">
              <a href="/vela2">
                <Button primary>Monte a sua</Button>
    ...
    <div className="image-cut">
      <a href="/vela2">
        <img
          src="https://firebasestorage.googleapis.com/v0/b/vela-c1f68.appspot.com/o/public%2Fvelastore%2FSmartbikeVelaBike.jpg?alt=media&token=45e92ba1-b417-4536-8b66-6347d7d272bf"
          alt="Vela Bike Elétrica Smart"
        />
      </a>
      <div className="tagline">
        <h2>Tecnologia e design nunca estiveram tão próximos</h2>
        <h4>
          O design minimalista da Vela é a prova de que bikes elétricas podem
          reunir tecnologia de ponta e beleza.{" "}
        </h4>
        <div className="actions">
          <a href="/vela2">
            <Button primary>Monte a sua</Button>
    ...
    <div className="app-content">
      <PaddedView>
        <div className="section">
          <div className="right">
            <div className="right-content">
              ...
              <h4>
                Conte com auxílio e muito mais tranquilidade nas pedaladas
              </h4>
              <p>
                Utilize o bloqueio eletromagnético, receba notificações de
                atividades suspeitas e consulte o mapa para se deslocar pela
                cidade com o melhor que uma bicicleta elétrica tem a oferecer:
                eficiência.
              </p>
            </div>
          </div>
        ...
        <div className="app-img">
          <a href="/vela2">
            <img
              src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/55068f24-1c81-4bdc-bec3-3f9d0e586a79.png"
              alt="App Vela 2"
            />
          </a>
        </div>
    ...
    <PaddedView>
      <div className="section">
        <div className="right">
          <div className="right-content">
            ...
            <h4>
              A smartbike conectada com as ruas, com seu celular e com você
            </h4>
            <p>
              O aplicativo da Vela te acompanha pelo caminho, mostrando em tempo
              real as informações essenciais para velejar com tranquilidade.
            </p>
            <div className="actions">
              <a href="/vela2">
                <Button primary>Monte a sua</Button>
          ...
          <a href="/vela2">
            <img
              src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/7130ce6f-5e4c-4472-bfc8-9855e17f0a92.jpg"
              alt="Smartbike Vela 2"
            />
          </a>
        </div>
      </div>
      <div className="bfunction-content">
        <img
          src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/38f776ca-ba8a-41c8-9452-fe132d492fa0.png"
          alt="Botão multifunções smartbike"
        />
      ...
      <div className="section">
        <div className="left">
          <a href="/vela2">
            <img
              src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/d72b6886-6e78-40ff-a8d9-0e2d12fe5974.jpg"
              alt="Design urbano bike elétrica"
            />
          </a>
          <div className="left-content">
            <h2>Design atemporal</h2>
            <h4>
              Cada detalhe é pensado para oferecer muito conforto, com
              acabamento artesanal e uma paleta de cores exclusivas
            </h4>
            <p>
              Escolher a Vela é adotar uma nova forma de transporte, agilizar o
              tempo no trânsito e se aventurar por melhores experiências na
              cidade.
            </p>
          </div>
        </div>
        <div className="right">
          <div className="right-content">
            ...
            <h4>
              Equipada com todos os acessórios essenciais para o dia a dia
            </h4>
            <p>
              A tranquilidade de pedalar com faróis automáticos integrados,
              conjunto completo de paralamas, manoplas ergonômicas e mudflaps.
            </p>
            <div className="actions">
              <a href="/vela2">
                <Button primary>Monte a sua</Button>
          ...
          <a href="/vela2">
            <img
              src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/9492947f-35ff-4f66-a9a2-4e6f8e8ea776.jpg"
              alt="Bike clássica elétrica"
            />
          </a>
        </div>
      </div>
    ...
    <div className="specs">
      <img
        src="https://mcusercontent.com/68a0cce7cc109d78a8b44d7a0/images/4bb2a891-d7dd-4934-8625-259d8c2c1df2.jpg"
        alt="Especificações técnicas bike"
      />
          ...
          <tbody>
            ...
            <tr className="tr-specs">
              ...
              <td className="td-specs">
                Aço liga 4130 CrMo - Chromoly - Total de 5 geometrias
                diferentes.
              </td>
            </tr>
            <tr className="tr-specs">
              ...
              <td className="td-specs">
                Eletrostática, verniz fosco. 5 cores exclusivas da Vela 2.
              </td>
            </tr>
            <tr className="tr-specs">
              <td className="td-specs">Tamanhos (quadro reto)</td>
              <td className="td-specs">
                51-26": 1,58 à 1,72 | 55-700C: 1,73 à 1,83 | 59-700C: 1,84 à
                2,00
              </td>
            </tr>
            <tr className="tr-specs">
              ...
              <td className="td-specs">
                49-26": 1,50 à 1,70 | 49-700C: 1,71 à 1,90
              </td>
            </tr>
            <tr className="tr-specs">
            ...
            <tr className="tr-specs">
              ...
              <td className="td-specs">
                Perfil 50mm (2''), urbanos com proteção antifuro.
              </td>
            </tr>
            <tr className="tr-specs">
              <td className="td-specs">Luzes</td>
              <td className="td-specs">
                Conjunto integrado em LED, acionamento automático.
              </td>
            </tr>
            <tr className="tr-specs">
            ...
            <tr className="tr-specs">
              ...
              <td className="td-specs">
                Ergonômicas, com trava e costuradas em couro sintético.
              </td>
            </tr>
            <tr className="tr-specs">
            ...
            <tr className="tr-specs">
              ...
              <td className="td-specs">
                Ergonômico, couro sintético com molas cromadas.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td>Bateria</td>
              <td>
                Integrada de lítio e removível | 378Wh de capacidade | Tensão
                nominal 36V.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                Notificações no app | Rastreamento GPS.
              </td>
            </tr>
            <tr>
              <td>Aplicativo</td>
              <td>
                Vela 2: iOS 14 + Android 10 | Configuração da Vela, mapa, modos
                de condução e atualizações de performance.
              </td>
            </tr>
            <tr>
              <td>Motor</td>

...
Para mais informações a respeito dos dispositivos SmartTag, acesse o link: https://www.samsung.com/br/mobile-accessories/galaxy-smarttag-black-ei-t5300bbegbr/  "
          ...
          <Accordion
            ...
            hoverColor={"#DCF5EB"}
            textColor={offBlack}
            title="4. Como é feita a instalação da AirTag ou SmartTag?"
            content="Os dispositivos de rastreio são instalados diretamente na parte eletrônica da Vela, essa integração garante uma autonomia de até 15 anos, mesmo sem a alimentação da bateria da bike. Para garantir a cobertura do plano e longevidade do dispositivo de rastreio, a instalação deve ser feita na nossa fábrica em São Paulo, em qualquer autorizada ou oficina de sua confiança. A instalação é simples e leva cerca de 24h. "
          />
          <Accordion
            color={white}
            hoverColor={"#DCF5EB"}
          ...
          <Accordion
            ...
            hoverColor={"#DCF5EB"}
            textColor={offBlack}
            title="7. Como funciona o pagamento do plano?"
          ...
          <Accordion
            ...
            hoverColor={"#DCF5EB"}
            textColor={offBlack}
            title="8. Posso cancelar antes do término dos 12 meses?"
          ...
          <Accordion
            ...
            hoverColor={"#DCF5EB"}
            textColor={offBlack}
            title="14. A proteção cobre os custos dos acessórios, se estiverem instalados na bike?"
          ...
          <Accordion
            ...
            hoverColor={"#DCF5EB"}
            textColor={offBlack}
            title="15. Quais são as condições para a gratuidade dos Serviços Leva&Traz?"
            content="A gratuidade atualmente é válida apenas para a Grande São Paulo e pode ser acionada para a realização de serviços exclusivamente com a Vela. Exemplo: a gratuidade vale para o transporte para a realização de uma revisão ou reparo na fábrica da Vela."
          />
        </PaddedView>
      </div>

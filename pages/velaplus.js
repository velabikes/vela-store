...
return (
    <div className="velaplus">
      <Head>
        ...
        <meta name='description' content='Você e a Vela: um relacionamento sério. Assine nosso plano com rastreamento GPS, proteção contra roubo e furto e muitos mais para sua bike elétrica!' />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:site" content="@velabikes" /> 
        <meta name="twitter:title" content="Plano Vela+ - Vela Bikes" />
        <meta name="twitter:description" content="Você e a Vela: um relacionamento sério. Assine nosso plano com rastreamento GPS, proteção contra roubo e furto e muitos mais para sua bike elétrica!" />
        ...
        <meta property='og:description' content='Você e a Vela: um relacionamento sério. Assine nosso plano com rastreamento GPS, proteção contra roubo e furto e muitos mais para sua bike elétrica!' />
      ...
      <div className='cover'>
        <div className='cta'>
            <h1>Vela<span style={{display: 'none'}}>Mais</span></h1>
            <BadgePlus />
        </div>
      </div>
      <div className='call'>
        <div className='add'>
          <h2>R$ 69,90/mês</h2>
          <h5>Pacote anual cobrado em até 12x sem juros no cartão de crédito.</h5>
          <hr/>
          <p><AddIcon style={{width: '1.2em'}} />Proteção contra roubo e furto</p>
          <p><AddIcon style={{width: '1.2em'}} />Notificações remotas</p>
          <p><AddIcon style={{width: '1.2em'}} />Rastreamento GPS</p>
          <p><AddIcon style={{width: '1.2em'}} />Descontos em produtos e serviços</p>
          <p><AddIcon style={{width: '1.2em'}} />Funções e atualizações exclusivas</p>
          <p><AddIcon style={{width: '1.2em'}} />Desconto em novas baterias</p>
          <p><AddIcon style={{width: '1.2em'}} />Benefícios com parceiros</p>
          <div className='action'>
            <Button primary>Assinar</Button>
          </div>
        </div>
        <div className='description'>
          <h2>Você e a Vela: um relacionamento sério</h2>
          <h4>Muito mais do que proteção contra roubo e furto, o plano oferece uma série de vantagens exclusivas para você e para sua Vela.</h4>
          <p>A assinatura pode ser feita ao comprar sua Vela 2 ou diretamente nessa página em apenas 3 clicks. Simples e rápido, como nossa smartbike.</p>
        </div>
      </div>
      ...
      <PaddedView>
        <div className="security">
          ...
          <div className="sdescript">
            ...
            <h4>Com rastreamento GPS integrado e desconto em produtos, peças e serviços. Você não precisa se preocupar, apenas Velejar!</h4>
          </div>
        </div>
        <div className="callcenter">
          ...
          <div className="cdescript">
            ...
            <h4>Funções exclusivas no Vela App, atendimento exclusivo em até 24 horas e todo o suporte que você precisa para sua bike.</h4>
          </div>
        </div>
      </PaddedView>
      </div>
      <div className="models-content">
        <div className="models">
          <div className="m1">
            ...
            <p>
              Em qualquer produto ou serviço da Vela. Acessórios lindos, peças de manutenção e revisões para os assinantes. Inclusive na compra de uma nova bike!
            </p>
          </div>
          <div className="m2">
            <h3>Desconto em novas baterias</h3>
            <p>
              Sabemos da importância da bateria para a nossa relação e, por isso, oferecemos 30% de desconto na compra de uma nova. Sempre bom ter uma reserva, né?
            </p>
          </div>
          <div className="m3">
            <h3>Benefícios com parceiros</h3>
            <p>
              Nossos Velejadores terão benefícios com todos os nossos parceiros atuais e que estão por vir. Descontos, brindes e outras vantagens para o cliente Vela+.
            </p>
          </div>
        </div>
      </div>

...
const BlogPostPage = ({ cover, title, teaser, date }) =>
  <PaddedView>
    <Main>
      <Head>
      ...
      <MainHeader
        ...
        tagline={<div>
          ...
          <div><small>{JSON.stringify(date)}</small></div>
        </div>}
      />
    </Main>
    ...
    <Grid template='1fr 1fr'>
      ...
      <div className='SectionBody' dangerouslySetInnerHTML={{ __html: teaser[0].text }} />
    </Grid>

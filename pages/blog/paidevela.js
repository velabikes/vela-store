  ...
  <PaddedView>
    <Main>
      ...
      <MainHeader
        title='#PAIDEVELA'
        tagline={<div>
          <div>Bruno vê o futuro com uma maior cultura de ciclismo para seus filhos</div>
          <div><small>Quarta-feira, 14 de agosto de 2019</small></div>
        </div>}
      />
    </Main>
    ...
    <table class="Content">
      ...
      <div className="SectionBody">
        ...
        <p>Bruno Bianchini <Link href="https://instagram.com/brunobcsb">@brunobcsb</Link> - Pai, publicitário e Velejador </p>
      </div>
    </table>

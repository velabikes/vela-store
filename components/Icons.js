...
export const MarkerServiceIcon = props => (
  <svg viewBox="0 0 97.14 128.36" width="1em" height="1em" {...props}>
    ...
    <g data-name="Camada 2">
      <g data-name="Camada 1">
        <path
          d="M97.14 53.86a81.58 81.58 0 00-1.27-14.42C91.16 13.12 69.82 0 48.5 0h.07a51.62 51.62 0 00-11.94 1.4c-16.8 4-31.54 16.7-35.36 38A82.54 82.54 0 000 53.86a81.42 81.42 0 0048.57 74.5 81.4 81.4 0 0048.57-74.5z"
          fill="#4f7ea8"
        />
        <path
          d="M68.18 60.18a18.94 18.94 0 000-5.21l5.64-4.41a1.32 1.32 0 00.32-1.71L68.8 39.6a1.31 1.31 0 00-1.62-.6l-6.65 2.68a20.25 20.25 0 00-4.53-2.6L55 32a1.37 1.37 0 00-1.33-1.12H43A1.35 1.35 0 0041.69 32l-1 7.07a19.72 19.72 0 00-4.51 2.63L29.54 39a1.34 1.34 0 00-1.63.57l-5.34 9.25a1.34 1.34 0 00.32 1.71L28.52 55a18.94 18.94 0 000 5.21l-5.63 4.41a1.33 1.33 0 00-.32 1.71l5.34 9.25a1.32 1.32 0 001.63.57l6.64-2.68a20.47 20.47 0 004.51 2.63l1 7.07A1.35 1.35 0 0043 84.26h10.69A1.35 1.35 0 0055 83.14l1-7.07a19.72 19.72 0 004.51-2.63l6.64 2.68a1.34 1.34 0 001.63-.57l5.34-9.25a1.34 1.34 0 00-.32-1.71zm-19.83 10A12.65 12.65 0 1161 57.57a12.64 12.64 0 01-12.65 12.65z"
          fill="#f5f5f5"
        />
      </g>
    </g>

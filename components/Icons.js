...
export const NextIcon = (props) => (
  <div className="NextIcon">
    <svg width="1em" height="1em" viewBox="0 0 15.583 15.175" {...props}>
      <path d="M14.583 6.593H3.413l4.88-4.88a1.008 1.008 0 0 0 0-1.42 1 1 0 0 0-1.41 0l-6.59 6.59a1 1 0 0 0 0 1.41l6.59 6.59a1 1 0 1 0 1.41-1.41l-4.88-4.88h11.17a1 1 0 0 0 0-2z" />
    </svg>
    <style jsx>{`
      .NextIcon {
...
export const CartIcon = compose(withCheckout)(
  ({ checkout, width, height, ...props }) => (
    <div className="CartIcon">
      ...
      >
        <path d="M8.2 17c-1 0-1.7.8-1.7 1.7 0 .9.8 1.7 1.7 1.7.9 0 1.8-.7 1.8-1.7S9.2 17 8.2 17zM3 3.9c0 .5.4.9.9.9h.9l3.1 6.6-1.2 2.1c-.5.8-.2 1.9.7 2.4.3.1.6.2.8.2h9.6c.5 0 .9-.4.9-.9s-.4-.9-.9-.9H8.2l1-1.7h6.5c.6 0 1.2-.3 1.5-.9L20.3 6c.2-.4.1-.9-.3-1.2-.1-.1-.3-.1-.5-.1H6.7l-.6-1.2C6 3.2 5.6 3 5.3 3H3.9c-.5 0-.9.4-.9.9zM17 17c-1 0-1.7.8-1.7 1.7 0 .9.8 1.7 1.7 1.7.9 0 1.7-.8 1.7-1.7 0-.9-.7-1.7-1.7-1.7z" />
      </svg>
      <style jsx>{`
        .CartIcon {
          transition: 0.3s all;
...
export const MarkerPlaceIcon = (props) => (
  <svg viewBox="0 0 48 48" fill="none" {...props}>
    <path d="M0 0h48v48H0z" />
    <path
      d="M23.5 6C15.961 6 10 12.49 10 20.383c0 9.822 12.097 20.696 12.623 21.222.526.527 1.403.527 1.754 0C24.903 41.08 37 30.205 37 20.383 36.825 12.49 30.864 6 23.5 6z"
...
export const MarkerGrudiIcon = (props) => (
  ...
  >
    ...
    <g clipPath="url(#clip0_0_1)">
      <path
        d="M9.00365 0C3.97564 0 0 4.32643 0 9.58831C0 16.1364 8.06821 23.3861 8.419 23.7369C8.76979 24.0877 9.35445 24.0877 9.58835 23.7369C9.93905 23.3861 18.0074 16.1364 18.0074 9.58831C17.8904 4.32643 13.9148 0 9.00365 0Z"
        fill="#2D2D2D"
      />
      <rect x="4" y="6" width="10" height="12" fill="url(#pattern0)" />
    </g>
    <defs>
      <pattern
        id="pattern0"
      ...
      >
        <use
          ...
          transform="translate(0 -0.00112613) scale(0.0045045 0.00375375)"
        />
      </pattern>
      ...
      <image
        ...
        width="222"
        height="267"
        xlinkHref="data:image/png;base64,"
      />
    </defs>
  </svg>
);
...
export const Navigation = (props) => (
  <svg viewBox="0 0 32 32" fill="none" {...props}>
    <path
      d="M26.4677 5.53245C26.2276 5.29229 25.8673 5.29229 25.6272 5.41237L5.8137 13.9382C5.45346 14.0583 5.33337 14.4185 5.33337 14.7787C5.33337 15.139 5.57354 15.3792 5.93378 15.4992L14.0993 17.9009L16.501 26.0664C16.6211 26.4267 16.8612 26.6668 17.2215 26.6668C17.5817 26.6668 17.8219 26.4267 17.9419 26.1865L26.5878 6.37303C26.7079 6.13286 26.7079 5.77262 26.4677 5.53245Z"
      fill="#4B4A4A"
    />
  </svg>
);
...
export const GPS = (props) => (
  ...
  >
    <path
      d="M11.75 3C7.98052 3 5 6.24482 5 10.1912C5 15.1023 11.0487 20.5396 11.3117 20.8027C11.5747 21.0658 12.013 21.0658 12.1883 20.8027C12.4513 20.5396 18.5 15.1023 18.5 10.1912C18.4123 6.24482 15.4318 3 11.75 3Z"
      fill="#7B7B7B"
    />
  </svg>
);
